...
public class Ejercicio3 extends JFrame {
    ...
    public Ejercicio3() {
        ...
        panelSistema.setBorder(BorderFactory.createLineBorder(Color.BLACK)); // Borde sin título
        ...
        panelEspecialidad.setBorder(BorderFactory.createLineBorder(Color.BLACK)); // Borde sin título
        ...
        JCheckBox checkBoxP = new JCheckBox("Programación");
        checkBoxP.setBounds(177, 9, 113, 25);
        panelSistema.add(checkBoxP);

        JCheckBox checkBoxA = new JCheckBox("Administración");
        checkBoxA.setBounds(177, 33, 113, 25);
        panelSistema.add(checkBoxA);

        JCheckBox checkBoxDG = new JCheckBox("Diseño Gráfico");
